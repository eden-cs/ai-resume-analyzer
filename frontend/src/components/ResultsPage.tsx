  ...
  return (
    <div className="min-h-screen bg-cream">
      <div className="max-w-[900px] mx-auto px-[90px] py-[60px]">
        ...
        {/* Page heading */}
        <h1 className="font-display text-espresso text-[24px] font-semibold mb-7">
          Your results
        </h1>
        ...
        <div className="bg-taupe border border-espresso/12 rounded-xl p-5 mb-3">
          {/* Card label */}
          <p className="font-body font-medium text-[10px] tracking-[0.13em] uppercase text-espresso opacity-60 mb-2">
            Match score
          </p>
        ...
        {allMatched ? (
          ...
          <div className="bg-success-bg border border-success/25 rounded-xl p-5 mb-3">
            {/* Card label */}
            <p className="font-body font-medium text-[10px] tracking-[0.13em] uppercase text-success mb-2">
              Keywords
            </p>
            ...
            <p className="font-body font-light text-[12px] text-success opacity-80">
              Your resume is well-tailored for this role — no critical keywords
              are missing.
            </p>
          </div>
        ) : (
        ...
        {/* Feedback card */}
        {!allMatched && <FeedbackCard feedback = {results.feedback} />}

        {/* Suggestions card */}
        {!allMatched && <SuggestionsList suggestions = {results.suggestions} />}
      </div>
    </div>
  );
}
